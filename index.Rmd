...
### 2.2 Fundamentals Power BI and data visualization

- Power BIs platform for sharing reports

<!--

### 2.3 Importing data and creating a report
...
### 2.4 Build data model with more data
...
### 2.5 Themes and sharing JSON-files
...
<a href="https://docs.microsoft.com/en-us/power-bi/create-reports/desktop-report-themes">Documentation: Use report themes in Power BI Desktop</a>

### 2.6 Import data from Eurostat API using a custom connector
<iframe src="https://player.vimeo.com/video/536746730?color=90cc93&portrait=0" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
...
### 2.7 Import data from SSBs APIs

Import data from KLASS
